...
export const PALIRO_WEB_VAULT_DIRECTORY = 'PaliroWebVault'
...
export const PALIRO_BOOTSTRAP_ARCHIVE = 'paliro-bootstrap.pwb'
export const PALIRO_ASSET_ARCHIVE_PREFIX = 'paliro-assets-'
